<template>
  <div class="container">
    <h2 class="page-title">Customer Cash In</h2>
    <div class="top-box">
      <el-card>
        ...
        <div class="illustrate">*Customer cash in means the transaction is created by customer</div>
      </el-card>
    </div>
    <div class="table-box">
      <el-card>
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const goDetail = (row) => {
      $router.push('/transactions/cash-in/customer-cash-in-detail/123')
    }

    onBeforeMount(() => {
      console.log($route.query.id, '$route.query.id')
      state.transactionId = $route.query.id
    })
    return {
      ...toRefs(state),
      search,
