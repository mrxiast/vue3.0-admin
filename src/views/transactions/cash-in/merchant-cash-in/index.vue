<template>
  <div class="container">
    <h2 class="page-title">Merchant Cash In</h2>
    <div class="top-box">
      <el-card>
    ...
    <div class="table-box">
      <el-card>
        ...
        >
          ...
          <el-table-column align="center" label="Wallet Balance"></el-table-column>
        </el-table>
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const goDetail = (row) => {
      $router.push('/transactions/cash-in/merchant-cash-in-detail/123')
    }
    return {
      ...toRefs(state),
      search,
