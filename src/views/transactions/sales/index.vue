    ...
    <div class="table-box">
      <el-card>
        ...
        >
          ...
          <el-table-column prop="mobile" label="Merchant Name" align="center" />
          <el-table-column prop="mobile" label="Payment Option" align="center" />
          <el-table-column prop="agentId" label="Transaction Amount" align="center" />
          ...
          <el-table-column align="center" label="MDR"></el-table-column>
          <el-table-column align="center" label="Settled Amount"></el-table-column>
          <el-table-column align="center" label="Status"></el-table-column>
          <el-table-column align="center" label="Merchant wallet balance"></el-table-column>
        </el-table>
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const goDetail = (row) => {
      ...
      $route.push('/sales/sale-detail/001')
    }
